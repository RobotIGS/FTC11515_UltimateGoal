...
public class OmniwheelControl {
    ...
    static final double     WHEEL_DIAMETER_CMS      = GeneralTools.WHEEL_RADIUS * 2;     // For figuring circumference
    static final double     COUNTS_PER_CM           = (COUNTS_PER_MOTOR_REV * DRIVE_GEAR_REDUCTION) / (WHEEL_DIAMETER_CMS * Math.PI);

    private Telemetry telemetry; 
    BaseHardwareMap robot;

    public OmniwheelControl(BaseHardwareMap robot, Telemetry telemetry) {
        this.robot = robot;
